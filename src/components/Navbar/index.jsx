    ...
    return (
        <div className="flex flex-col items-center justify-center py-6 gap-y-5 md:flex-row md:justify-between">
            ...
            <div className="flex flex-row gap-x-5 font-bold tracking-wide md:gap-x-4">
                {/* <a href="#home" className="transition-all hover:scale-[1.05] hover:border-b-4 hover:border-blue-500">About</a> */}
                <a href="#home" className="transition-all hover:scale-[1.05]">About</a>
                <a href="#work" className="transition-all hover:scale-[1.05]">Work</a>
                <a href="#get-in-touch" className="transition-all hover:scale-[1.05]">Get in touch</a>
                <a href="#projects" className="transition-all hover:scale-[1.05]">Projects</a>
            </div>
        </div>
    );
}
