export const data = {
    ...
    "heroSection": {
        ...
        "subtitle": "Over the last 7 years, I helped some big brands build performant user interfaces for their web apps to deliver seamless user experiences. I can help you do the same.",
        "techStackBanner": {
            ...
            "workExperiences": [
                {
                    ...
                    "skillsUsed": [
                        "HTML", "CSS", "Javascript", "ASP.Net MVC", "SQL Server", "Project Management", "Python"
                    ]
                },
                {
                    "id": 2,
                    ...
                    "skillsUsed": [
                        "React", "Redux", "HTML", "CSS", "Javascript", "SASS", "Git", "Github"
                    ]
                },
                {
                    "id": 3,
                    ...
                    "achievements": [],
                    "skillsUsed": [
                        "HTML", "CSS", "JavaScript", "AJAX", "Project Management", "Git", "BitBucket"
                    ]
                },
                {
                    "id": 4,
                    ...
                    "summary": "Working in the Payment Gateway Team, developing highly scalable Checkout JS Library that enables seamless online payments across desktop and mobile devices.",
                    "achievements": [],
                    "skillsUsed": [
                        "React JS", "Redux", "Hooks", "Javascript", "HTML", "CSS", "NodeJS", "Git", "Webpack", "Jest", "Enzyme"
                    ]
                }
            ]
        },
            ...
            "projects": [
                {
                    ...
                    "summary": "I built this app to showcase my skills and share my knowledge with a larger audience. The app is built with ReactJS, Redux toolkit, Styled Components, and Mirage JS. The app has a fully working video player with tracking of currently watching content and a watch list.",
                    ...
                    "techUsed": [
                        "ReactJS", "Javascript", "Redux toolkit", "Mirage JS", "Styled Components"
                    ]
                }
            ]
        }
    ...
    "contactSection" : {
        "title": "Get in touch",
        "contactMessage": "I'm always excited to talk about anything frontend and work on some exciting projects. Have a question? message me and let's discuss it over a coffee.",
        "cta": {
            "type": "email",
